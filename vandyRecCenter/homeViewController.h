...
#define ARROW_BORDER_PADDING_PORTRAIT 10
#define ARROW_BORDER_PADDING_LANDSCAPE 30
#define ARROW_DIMENSIONS_PORTRAIT 20
#define ARROW_DIMENSIONS_LANDSCAPE 60
